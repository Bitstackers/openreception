...
abstract class ModelMessageRecipientList {
  static void buildObject () {
    final Model.MessageRecipient recipient1_2 =
    ...
    final Model.MessageRecipient recipient2_2 =
      new Model.MessageRecipient()
          ..role = Model.Role.TO
          ..contactID = 2
          ..contactName = '2'
    ...
    final Model.MessageRecipient recipient2_3 =
      new Model.MessageRecipient()
          ..role = Model.Role.CC
          ..contactID = 2
          ..contactName = '2'
    ...
    final Model.MessageRecipient recipient2_4 =
      new Model.MessageRecipient()
          ..role = Model.Role.BCC
          ..contactID = 2
          ..contactName = '2'
    ...
    final Model.MessageRecipient recipient2_5 =
      new Model.MessageRecipient()
          ..role = Model.Role.BCC
          ..contactID = 2
          ..contactName = '2'
    ...
    Model.MessageRecipientList dlist =
      new Model.MessageRecipientList.empty();
