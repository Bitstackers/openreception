...
INSERT INTO receptions (id, full_name, uri, attributes)
VALUES  (4, 'Hansen VVS A/S', 'hansen_vvs_4', '{"addresses":[],"alternatenames":[],"bankinginformation":[],"crapcallhandling":[],"customertype":"","emailaddresses":[],"greeting":"Hansen vvs. Hvad vil du?","handlings":[],"openinghours":[],"other":"","product":"","registrationnumbers":[],"telephonenumbers":[],"websites":[],"short_greeting":"Du taler med..."}');
