...
import 'package:openreception.framework/service-io.dart' as serviceIO;
...
Future<io.HttpServer> start(
  ...
  var router = shelf_route.router()
    ...
    ..get('/user/history', userController.history)
    ..get('/user/{uid}', userController.get)
    ..get('/user/{uid}/history', userController.objectHistory)
