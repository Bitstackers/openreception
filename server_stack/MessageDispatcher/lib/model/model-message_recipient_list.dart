...
class MessageRecipientList {
  ...
  List<MessageRecipient> get to  => this.recipients[Role.TO];
  List<MessageRecipient> get cc  => this.recipients[Role.CC];
  List<MessageRecipient> get bcc => this.recipients[Role.BCC];
  
  /// Returns a list of every recipient, regardless of role.
  List<MessageRecipient> get all => 
      []..addAll(this.to)
        ..addAll(this.cc)
        ..addAll(this.bcc);
