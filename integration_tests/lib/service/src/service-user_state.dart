...
abstract class UserState {
  ...
  static Future originateForbidden(
    ...
    return Future.wait([])
        ...
        .then((_) => expect(receptionist.originate(callee.extension, context),
            throwsA(new isInstanceOf<Storage.ClientError>())));
  }

  static Future pickupForbidden(
      Receptionist receptionist, Customer caller, Customer second_caller) {
    String receptionNumber = '12340005';
    ...
    return Future.wait([])
        ...
        .then((_) => receptionist
            .huntNextCall()
            .then((Model.Call call) => log.info('$receptionist got $call')))
        ...
        .then((_) => expect(receptionist.pickup(secondCall),
            throwsA(new isInstanceOf<Storage.ClientError>())));
  }
}
