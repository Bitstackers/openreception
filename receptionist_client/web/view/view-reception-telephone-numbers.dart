...
class ReceptionTelephoneNumbers extends ViewWidget {
  ...
  final ui_model.UIReceptionTelephoneNumbers _uiModel;

  /**
   * Constructor.
   */
  ReceptionTelephoneNumbers(
      ui_model.UIReceptionTelephoneNumbers this._uiModel,
  ...
  @override
  ui_model.UIReceptionTelephoneNumbers get _ui => _uiModel;
