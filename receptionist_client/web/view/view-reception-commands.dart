...
/**
 * The reception commands for general call handling.
 */
class ReceptionCommands extends ViewWidget {
  final controller.Destination _myDestination;
  final ui_model.UIReceptionSelector _receptionSelector;
  final ui_model.UIReceptionCommands _uiModel;

  /**
   * Constructor.
   */
  ReceptionCommands(
      ui_model.UIReceptionCommands this._uiModel,
  ...
  @override ui_model.UIReceptionCommands get _ui => _uiModel;
  ...
  void _observers() {
    ...
    _hotKeys.onAltH.listen((KeyboardEvent _) => _activateMe());
