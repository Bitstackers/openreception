...
/**
 * Provides methods for manipulating the reception alternate names UI widget.
 */
class UIReceptionAltNames extends UIModel {
  final DivElement _myRoot;

  /**
   * Constructor.
   */
  UIReceptionAltNames(DivElement this._myRoot) {
    _setupLocalKeys();
    _observers();
  }
  ...
  /**
   * Add [items] to the reception alternate names list.
   */
  set altNames(List<String> items) {
