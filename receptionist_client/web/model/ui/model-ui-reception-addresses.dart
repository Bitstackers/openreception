...
/**
 * Provides methods for manipulating the reception addresses data UI widget.
 */
class UIReceptionAddresses extends UIModel {
  final DivElement _myRoot;

  /**
   * Constructor.
   */
  UIReceptionAddresses(DivElement this._myRoot) {
    _setupLocalKeys();
    _observers();
  }
